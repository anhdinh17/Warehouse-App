...
final class DatabaseManager {
    ...
    public func readItems(completion: @escaping ([String:Any]?,String?)->Void){
        ...
        Database.database().reference(withPath: "Items").observe(.childAdded){snapshot in
            ...
            //print("Read item with childByAutoId SNAPSHOT: \(snapshot)")
            //print("Read item with childByAutoId SNAPSHOT.VALUE: \(snapshot.value)")
        }
    }
    ...
    func readDataFromReceivers(completion: @escaping ([String:Any])->Void){
        database.child("Receivers").observeSingleEvent(of: .value) { snapshot in
